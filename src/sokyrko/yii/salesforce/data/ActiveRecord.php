...
class ActiveRecord extends Model implements ActiveRecordInterface
{
    ...
    {
        return (new \ReflectionClass(static::class))->getShortName() . (static::$isCustom ? '__c' : '');
    }
    ...
    {
        return ['Id']; // can be something else?
    }
    ...
    public function getPrimaryKey($asArray = false)
    {
        ...
        return $this->{reset(self::primaryKey())};
    }
    ...
    {
        return $this->getPrimaryKey($asArray); // is required?
    }
    ...
    {
        throw new InvalidCallException('Not implemented yet.'); // TODO: full CRUD?
    }
    ...
    {
        return \Yii::$app->get('salesforce'); // TODO: should be editable?
    }
}
